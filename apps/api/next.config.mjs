...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "object-src 'none'",
      `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net ${clerkHosts.join(" ")}`,
      `script-src-elem 'self' 'unsafe-inline' https://cdn.jsdelivr.net ${clerkHosts.join(" ")}`,
